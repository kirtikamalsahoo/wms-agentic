            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <div className="mt-4 text-center text-sm text-gray-300">
                  ...
                  <div>Used Racks: <span className="text-purple-300 font-medium">{totalUsed}</span></div>
                  <div>Free Racks: <span className="text-orange-400 font-medium">{Math.max(0, totalCapacity - totalUsed)}</span></div>
                </div>
              </div>
            </div>
